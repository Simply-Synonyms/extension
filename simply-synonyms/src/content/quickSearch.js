  ...
  initialize () {
    ...
    popup.popup.addEventListener('keypress', (e) => {
      if (e.key === 'Enter' && this.isOpen) {
        browser.runtime.sendMessage(null, { action: 'openQuickSearch', dictionaryProvider: this.dictionaryProvider, searchDictionary: this.searchDictionary, word: e.target.value })
        this.reset()
      }
    })
